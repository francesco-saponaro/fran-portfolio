...
import { newProjectAction, clearErrors } from '../../actions/adminActions';
...
const NewProject = () => {
    ...
    useEffect(() => {
        ...
        // If success is true in the store, meaning the project was created successfully,
        // redirect the user to the admin page, show the success alert and dispatch 
        // the NEW_PROJECT_RESET action which will reset the success
        // to false since at this point the new project will have been created.
        if(success) {
    ...
    const submitHandler = (e) => {
        ...
        if(name !== '' && description !== '') {
            dispatch(newProjectAction(form));
        } else {
            alert.error('Please enter both name and description')
        }
    }
    ...
    return(
        <>
        {/* Custom title */}
        <Helmet><title>Francesco - New Project</title></Helmet>
